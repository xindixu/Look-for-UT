...
//  Group15Alpha
//
//  Created by Xu, Xindi on 10/23/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Group15Alpha", withExtension: "momd")!
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Group15Alpha")
